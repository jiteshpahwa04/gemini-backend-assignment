...
// Instantiate the Gemini client (will pick up your env‐provided API key)
...
async function startWorker() {
  // 1️⃣ Create the consumer group if it doesn't exist
  try {
  ...
  // 2️⃣ Continuously read new entries
  while (true) {
    try {
